...
const memeClasses = {
    'static/gifs/00.gif': 'doge mx-auto max-w-[40px] inline-block',
    'static/gifs/01.gif': 'doge mx-auto max-w-[35px] inline-block',
    'static/gifs/02.gif': 'doge mx-auto max-w-[50px] inline-block',
    'static/gifs/03.gif': 'doge mx-auto max-w-[40px] inline-block',
    'static/gifs/04.gif': 'doge mx-auto max-w-[40px] inline-block',
    'static/gifs/05.gif': 'doge mx-auto max-w-[45px] inline-block',
    'static/gifs/06.gif': 'doge mx-auto max-w-[70px] inline-block',
    'static/gifs/07.gif': 'doge mx-auto max-w-[40px] inline-block',
};
